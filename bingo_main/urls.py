...
urlpatterns = [
    ...
    path('register', bingo_main_views.bingo_main_register,
         name='bingo_main_register'),
    ...
    path('create_bingo/<str:album_id>',
    ...
    path('current_displayed_picture/<str:game_id>/',
         bingo_main_views.current_displayed_picture, name='current_displayed_picture'),
    path('player_card/<str:game_id>/<str:player_id>/<str:user_id>/',
         bingo_main_views.player_card, name='player_card'),
    path('player_approval_status/<str:game_id>/<str:player_id>/',
         bingo_main_views.player_approval_status, name='player_approval_status'),
    path('check_game_id/', bingo_main_views.check_game_id, name='check_game_id'),
    path('check_board/<str:game_id>',
         bingo_main_views.check_board, name='check_board'),
    path('game_over/<str:game_id>', bingo_main_views.game_over, name='game_over'),
    path('player_approval/<str:player_id>/<str:approval>',
         bingo_main_views.player_approval, name='player_approval'),

    # path('game_status/<str:game_id>', bingo_main_views.game_status, name='game_status'),
    path('players_approval_list/<str:game_id>',
         bingo_main_views.players_approval_list, name='players_approval_list'),
