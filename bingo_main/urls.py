...
urlpatterns = [
    ...
    path('register/<str:term>/<str:plan_id>', bingo_main_views.bingo_main_register,name='bingo_main_register'),
    ...
    path('player_board/<str:player_id>/',bingo_main_views.player_board, name='player_board'),
